...
def patched_timestep_encoder_forward(self, timestep):
    try:
        ...
        print("WARNING: Using patched TimestepEncoder forward method.")
...
# Set paths
dataset_path = "/ceph/home/student.aau.dk/xx06av/Groot_Implem/Isaac-GR00T/gr00t/New_results_0002"
output_dir = "/ceph/home/student.aau.dk/xx06av/Groot_Implem/Isaac-GR00T/gr00t/results"
