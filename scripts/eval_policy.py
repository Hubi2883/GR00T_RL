...
if __name__ == "__main__":
    ...
    parser.add_argument("--modality_keys", nargs="+", type=str, default=["left_wheel", "right_wheel"])
    parser.add_argument(
        "--data_config",
        type=str,
        default="two_wheel",
    ...
    parser.add_argument("--dataset_path", type=str, default="/ceph/home/student.aau.dk/xx06av/Groot_Implem/Isaac-GR00T/gr00t/New_results_0002")
    parser.add_argument(
        "--embodiment_tag",
        type=str,
